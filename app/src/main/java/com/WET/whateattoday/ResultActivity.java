...
//        super.onBackPressed();
    ...
    void getResult() {
        ArrayList<Food> foodList = divisionFood(category, spicy, price);
        resultFood = choiceFood(foodList);
    }

    Food choiceFood(ArrayList nowFood) {
        int nowLength = nowFood.size();
        Log.d("array 사이즈 : ", String.valueOf(nowFood.size()));
